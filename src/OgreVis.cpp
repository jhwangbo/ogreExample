...
std::string raisim::OgreVis::resourceDir_;
SceneManager *raisim::OgreVis::scnMgr_;
CameraMan *raisim::OgreVis::cameraMan_;
...
void OgreVis::loadMeshFile(const std::string &filename, const std::string &meshName) {
...
void OgreVis::generateMeshFile(const std::string &filename) {
...
//  viewPort->setBackgroundColour(ColourValue(0.05, 0.05, 0.05));
  ...
  addResourceDirectory(resourceDir_ + "/pbr");
